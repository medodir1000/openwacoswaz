...
export interface IWhatsAppEngine {
  ...
  // Presence — optional methods used to drive WhatsApp's "typing..." and
  // "seen" indicators. Adapters that can't surface these can leave them
  // undefined; MessageService gracefully skips them.
